     ...
     <ul class="nav navbar-nav">
		<?php 
		 ...
		 if($thispage=="courses")
		  {
		?> 
			<li class="active"><a href="Courses.php">Courses<img src="Pics\new\1.png" width=10px; height=10px;></a>
			  <ul>
				<li><a href="Courses.php">UG & PG Courses<img src="Pics\new\3.png" width=10px; height=10px;></a>
				  <ul>
				...
				<li><a href="Courses.php">Professionl/Vocational Courses<img src="Pics\new\3.png" width=10px; height=10px;></a>
				  <ul>
				    <li><a href="fashion.php">Fashion designing</a></li>
				    <li><a href="lawcourse.php">LAW</a></li>
					<li><a href="Other.php">OTHERS<img src="Pics\new\3.png" width=10px; height=10px;></a>
					 <ul>
	    ...
	    <?php
	      ...
	      {
	    ?>
			<li><a href="Courses.php">Courses<img src="Pics\new\1.png" width=10px; height=10px;></a>
			  <ul>
				<li><a href="Courses.php">UG & PG Courses<img src="Pics\new\3.png" width=10px; height=10px;></a>
				  <ul>
					<li><a href="mbacourse.php">MBA</a></li>
	    ...
	    <?php
	     ...
	     if($thispage=="college")
	      {
	    ?>
			<li class="active"><a href="College.php">Colleges<img src="Pics\new\1.png" width=10px; height=10px;></a>
			  <ul>
		...
		<?php
		  ...
		  {
		?>
			<li><a href="College.php">Colleges<img src="Pics\new\1.png" width=10px; height=10px;></a>
			  <ul>
				<li><a href="Gov_college.php">Government Colleges</a></li>
				<li><a href="Pvt_college.php">Private Colleges</a></li>
			  </ul>
		...
		<?php
		 ...
		 if($thispage=="about us")
		  {
			echo "<li class=\"active\"><a href=\"About Us.php\">About Us</a></li>";
		  }
		 else
		  {
		    echo "<li><a href=\"About Us.php\">About Us</a></li>";
		  }
		 if($thispage=="contactus")
		  {
		?>
		...
		<?php
		 ...
		 if($thispage=="ask")
		  {
		?>
			<li class="active"><a href="ask.php">Ask Experts</a></li>
		<?php
		  }
		 else
		  {
		...
		<?php
			...
			if(!(empty($_SESSION["userid"])))
		  {
				$uid=$_SESSION["userid"];
		?>	
		 <li><a href="Users/intro.php?id=<?php echo $uid; ?>">My Page</a></li>	
	  	 <li><a href="Users/Feedback.php?id=<?php echo $uid; ?>">Logout</a></li>
		<?php	 
		  } 
		?>
     </ul>
